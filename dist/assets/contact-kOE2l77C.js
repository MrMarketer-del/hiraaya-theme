import"./nav-CoHLXmV3.js";/* empty css              */document.addEventListener("DOMContentLoaded",()=>{const e=document.getElementById("inquiry-form");e&&e.addEventListener("submit",a=>{a.preventDefault();const n=document.getElementById("input-name"),o=document.getElementById("input-org"),i=n?n.value.trim():"Guest",r=o&&o.value.trim()?o.value.trim():"",s=r?`Thank you, <strong>${i}</strong>. We have enqueued your request regarding <strong>${r}</strong>.`:`Thank you, <strong>${i}</strong>. We have enqueued your request.`,t=e.parentElement;t.style.transition="opacity 0.5s cubic-bezier(0.16, 1, 0.3, 1)",t.style.opacity="0",setTimeout(()=>{t.innerHTML=`
