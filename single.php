            ...
            ?>
                <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                    <header class="entry-header" style="margin-bottom: 40px; text-align: center;">
                        ...
                        <h1 class="entry-title" style="font-family: var(--font-primary); font-size: 3rem; color: var(--color-burgundy); margin-top: 12px;"><?php the_title(); ?></h1>
                    ...
                    <footer class="entry-footer" style="margin-top: 56px; padding-top: 24px; border-top: 1px solid rgba(176, 159, 152, 0.2); display: flex; justify-content: space-between;">
